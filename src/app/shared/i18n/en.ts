export const locale = {
    ...
    data: {
        'about': {
            ...
            'mobility': 'Mobile throughout US',
            'years': 'Years',
            'graduation': "Bachelor's degree of Computer Science & Mathematics",
            'myResearch': 'Angular Developer',
        ...
        'education': {
            ...
            'detail':'Detail',
            'tripsCountries':'China, Canada, Turkey, Dubai',
            'boardGamesPlayed':'Monoploy and dominoes game, Among US, Clue, ..etc',
            'years':'years'
        },
        'header': {
            'home': 'Home',
